...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'profile',
        component: () => import('@/views/study/profile/index'),
        name: 'Profile',
...
export const dynamicRoutes = [
  {
    ...
    component: Layout,
    hidden: true,
    permissions: ['study:plan:detail'],
    children: [
      {
        path: 'detail/:planId(\d+)',
        component: () => import('@/views/study/plan/detail'),
        name: 'PlanDetail',
        meta: { title: '学习计划详情', activeMenu: '/study-plan' }
      }
    ]
  }
]
